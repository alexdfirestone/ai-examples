...
import { ScheduleView } from './components/components/ScheduleView';
import { PlannerChatMessage } from './components/components/PlannerChatMessage';
import { ChatInput } from './components/chat/ChatInput';
import { ErrorBanner } from './components/chat/ErrorBanner';
import { LoadingIndicator } from './components/chat/LoadingIndicator';
import { MessagesDebug } from './components/chat/messages-debug';
import type { ScheduleState } from '@/app/api/schedule-planner/tools';
import { DefaultChatTransport } from 'ai';
import { exampleSchedules } from './utils/utils/example-schedules';
import {
  ResizableHandle,
  ResizablePanel,
  ResizablePanelGroup,
