...
export function ChatMessage({ message, status, onDelete, onEdit }: ChatMessageProps) {
  return (
    <div 
      style={{ 
        marginBottom: '32px',
        ...
        <div style={{ 
          ...
          {message.parts.map((part: any, index: number) => {
            ...
            if (part.type === 'reasoning') {
              ...
              return isInProgress ? <div key={index} style={{ color: '#999', fontStyle: 'italic' }}>Thinking...</div> : null;
            }
            ...
            if (part.type === 'tool-displayWeather') {
              switch (part.state) {
                case 'input-available':
                  return <div key={index} style={{ color: '#999' }}>Loading weather...</div>;
                ...
                case 'output-error':
                  return <div key={index} style={{ color: '#666' }}>Error: {part.errorText}</div>;
                default:
                  return null;
              }
            }
