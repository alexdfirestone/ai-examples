...
export function UploadForm({ onSubmit, isLoading }: UploadFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-5 h-full flex flex-col">
        ...
        <div className="mb-4">
          ...
          <div className="space-y-3">
            <div>
              <label
                htmlFor="candidateId"
                className="block text-xs font-light text-zinc-500 mb-1.5 tracking-wide"
              >
                Candidate ID
              </label>
              <input
                ...
                disabled={isLoading}
                className="w-full px-3 py-1.5 bg-zinc-900 border border-zinc-800 text-zinc-300 text-sm font-light focus:outline-none focus:border-zinc-700 disabled:opacity-50 disabled:cursor-not-allowed placeholder:text-zinc-700 transition-colors"
              />
            </div>
      ...
      <div className="flex-shrink-0 pt-4 border-t border-zinc-800 mt-auto">
        <button
          type="submit"
          disabled={isLoading}
